...
import apirest.aiko.controllers.EquipmentStateController;
...
public class TestEquipmentState {
    ...
    void testServiceDelete_status200() throws Exception {
        var saved = equipmentStateRepository.findAll().get(0);
        Assertions.assertNotNull(saved);
        log.info("saved {}", saved);
        equipmentStateService.delete(saved);
        assertThrows(IndexOutOfBoundsException.class, () -> equipmentStateRepository.findAll().get(0));
